  ...
  Symbolics.@register_symbolic ESCIMO_IF_THEN_ELSE(condition, result_true, result_false)    #= C:\Users\johti17\OneDrive - Linköpings universitet\Projects\JuliaPackages\OM.jl\OMBackend.jl\src\CodeGeneration\MTK_CodeGeneration.jl:969 =#
  Symbolics.@register_symbolic ESCIMO_Population_Lookup_bn(y)    #= C:\Users\johti17\OneDrive - Linköpings universitet\Projects\JuliaPackages\OM.jl\OMBackend.jl\src\CodeGeneration\MTK_CodeGeneration.jl:969 =#
  Symbolics.@register_symbolic ESCIMO_STEP(my_time, height, step_time)    #= C:\Users\johti17\OneDrive - Linköpings universitet\Projects\JuliaPackages\OM.jl\OMBackend.jl\src\CodeGeneration\MTK_CodeGeneration.jl:969 =#
  Symbolics.@register_symbolic ESCIMO_ZIDZ(A, B)    #= C:\Users\johti17\OneDrive - Linköpings universitet\Projects\JuliaPackages\OM.jl\OMBackend.jl\src\CodeGeneration\MTK_CodeGeneration.jl:969 =#
  Symbolics.@register_symbolic ESCIMO_ln(x)    #= C:\Users\johti17\OneDrive - Linköpings universitet\Projects\JuliaPackages\OM.jl\OMBackend.jl\src\CodeGeneration\MTK_CodeGeneration.jl:969 =#
  Symbolics.@register_symbolic Modelica_Blocks_Tables_Internal_getDerTable1DValueNoDer(tableID::Ptr{Nothing}, icol, u, der_u)    #= C:\Users\johti17\OneDrive - Linköpings universitet\Projects\JuliaPackages\OM.jl\OMBackend.jl\src\CodeGeneration\MTK_CodeGeneration.jl:969 =#
  ...
  Symbolics.@register_symbolic Modelica_Blocks_Tables_Internal_getTable1DValueNoDer2(tableID::Ptr{Nothing}, icol, u)    #= C:\Users\johti17\OneDrive - Linköpings universitet\Projects\JuliaPackages\OM.jl\OMBackend.jl\src\CodeGeneration\MTK_CodeGeneration.jl:969 =#
  Symbolics.@register_symbolic Modelica_Blocks_Types_ExternalCombiTable1D_constructor(tableName, fileName, table, columns, smoothness, extrapolation, verboseRead)    #= C:\Users\johti17\OneDrive - Linköpings universitet\Projects\JuliaPackages\OM.jl\OMBackend.jl\src\CodeGeneration\MTK_CodeGeneration.jl:969 =#
  ...
  Symbolics.@register_symbolic Modelica_Utilities_Strings_Advanced_skipWhiteSpace(string, startIndex)    #= C:\Users\johti17\OneDrive - Linköpings universitet\Projects\JuliaPackages\OM.jl\OMBackend.jl\src\CodeGeneration\MTK_CodeGeneration.jl:969 =#
  Symbolics.@register_symbolic Modelica_Utilities_Strings_isEmpty(string)    #= C:\Users\johti17\OneDrive - Linköpings universitet\Projects\JuliaPackages\OM.jl\OMBackend.jl\src\CodeGeneration\MTK_CodeGeneration.jl:969 =#
  Symbolics.@register_symbolic Modelica_Utilities_Strings_length(string)    #= C:\Users\johti17\OneDrive - Linköpings universitet\Projects\JuliaPackages\OM.jl\OMBackend.jl\src\CodeGeneration\MTK_CodeGeneration.jl:969 =#
  begin
    begin
